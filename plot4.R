...
## Week 1 Peer-reviewsd Assignment 1 PLOT 4 (out of 4)
## Author: Amitava G.
...
{ 
  plot(dateTime, subsetData$Voltage, type="l", xlab="", ylab="Global Active Power (kilowatts)")
}
...
{
  plot(dateTime, subsetData$Global_reactive_power, type="l", lwd = 2, ylab="Global_reactive_power")
}
